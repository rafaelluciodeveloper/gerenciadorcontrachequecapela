        ...
        <div  id="centralizada">
            <div class="panel panel-default" >
                <div class="panel-heading">
                    <h3 class="panel-title" align="center"><b>Empresa -  [Editando]</b></h3>
                </div>
                <div>
                    <form action="${pageContext.request.contextPath}/empresas/atualizar" method="POST" >
                        <div class="form-group">
                            <label>Cod Empresa</label>
                            <input type="text" name="empresa.cod_empresa" value="${empresa.cod_empresa}" class="form-control"/>
                        </div>
                        <div class="form-group">
                            <label>Cnpj</label>
                            <input type="text" name="empresa.cnpj" value="${empresa.cnpj}" class="form-control"/>
                        </div>
                        <div class="form-group">
                            <label>Razão Social</label>
                            <input type="text" name="empresa.razaosocial" value="${empresa.razaosocial}" class="form-control"/>
                        </div>
                        <div class="form-group">
                            <label>Endereço</label>
                            <input type="text" name="empresa.endereco" value="${empresa.endereco}" class="form-control" />
                        </div>
